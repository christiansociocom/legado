          ...
          <Card>
            <CardHeader className="text-center">
              ...
              <p className="text-muted-foreground text-sm">
                {isSignUp ? "Join us for unforgettable adventures" : "Sign in to manage your bookings"}
              </p>
            </CardHeader>
            <CardContent className="space-y-4">
              ...
              <form onSubmit={handleEmailAuth} className="space-y-4">
                {isSignUp && (
                  <div><Label htmlFor="name">Full Name</Label><Input id="name" value={fullName} onChange={(e) => setFullName(e.target.value)} placeholder="Your full name" required /></div>
                )}
