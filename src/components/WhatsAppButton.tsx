...
const WhatsAppButton = () => {
  ...
  const phoneNumber = "255123456789"; // Tanzania number without +
      ...
      <AnimatePresence>
        {showTooltip && (
          <motion.div
            ...
            className="bg-white text-gray-800 text-sm font-medium px-3 py-2 rounded-lg shadow-lg border border-gray-100 whitespace-nowrap"
          >
            {t("whatsapp.tooltip")}
